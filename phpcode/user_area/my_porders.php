...
$select_orders_query = "SELECT * FROM user_orders WHERE user_id = '$user_id' AND order_state ='pending'";
...
if ($row['order_state'] == 'pending') {
    ...
    echo "<a href='confirm.php?invoice_no={$row['invoice_no']}'><button>Confirm</button></a>";
} else {
    echo "N/A"; // If the order is already complete, show N/A
}
echo "</td>";
        echo "</tr>";
