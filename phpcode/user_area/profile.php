...
<div class="row">
<div class="col-md-2 bg-secondary pro">
        <!--sidenav-->
        <!--Brand-->
        ...
        <ul class="navbar-nav me-auto text-center">
            <li class="nav-item bg-info">
                <a href="#" class="nav-link pro text-light px-0 b-0 m-0"><h4>Your Profile</h4></a>

            </li>
            <li class="nav-item ">
                <a href="?my_porders=true" class="nav-link text-light">Pending Orders</a>
            </li>
            <li class="nav-item ">
                <a href="?my_orders=true" class="nav-link text-light">My Orders</a>
            </li><li class="nav-item ">
                <a href="?edit_account=true" class="nav-link text-light" name="edit_account">Edit Account</a>
            </li><li class="nav-item ">
                <a href="?delete_account=true" class="nav-link text-light">Delete Account</a>
            </li><li class="nav-item ">
    ...
    <div class="col-md-10">
      ...
      }else if(isset($_GET['my_porders'])){
        include('my_porders.php');
