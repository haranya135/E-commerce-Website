...
include('../includes/connect.php');
    if(isset($_POST['insert_product_btn'])){
        ...
        if($product_title=='' or $product_description=='' or $product_keywords=='' or $product_category=='' or $product_price=='' or $product_image1=='')
        {
            ...
            $insert_products="insert into `products` (product_title,product_description,product_keywords,category_id,product_image1,product_price,date,status) 
            values('$product_title','$product_description','$product_keywords','$product_category','$product_image1','$product_price',NOW(),'$product_status')";
    ...
    <div class="container mt-3">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="file" name="product_image1" id="product_image" class="form-control"  required="required">
            </div>
            <!--price-->
            <div class="form-outline mb-4 w-50 m-auto">
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                <input type="submit" name="insert_product_btn" class="btn-info mb-3 px-3"  value="Insert Products">
            </div>
        </form>
    </div>
